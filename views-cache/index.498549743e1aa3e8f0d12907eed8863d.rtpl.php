<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="slider-area">
            <!-- Slider SLIDE AREA PRODUTOS DESLIZANDO PARA A ESQUERDA-->
            <div class="block-slider block-slider4">
                <ul class="" id="bxslider-home4">
                    ...
                    <li>
                        ...
                        <div class="caption-group">
                            <h2 class="caption title">
                                ect <span class="primary">10 <strong>xxx</strong></span>
                            </h2>
                            <h4 class="caption subtitle">Dual SIM</h4>
                            <a class="caption button-radius" href="#"><span class="icon"></span>COmprar</a>
                        </div>
                    ...
                    <li><img src="/res/site/img/h4-slide2.png" alt="Slide">
                        <div class="caption-group">
                            <h2 class="caption title">
                                by one, get one <span class="primary">90% <strong>off</strong></span>
                            </h2>
                            <h4 class="caption subtitle">XXX supplies & backpacks.*</h4>
                            <a class="caption button-radius" href="#"><span class="icon"></span>Comprar</a>
                        </div>
                    </li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="latest-product">
                        ...
                        <div class="product-carousel"> <!-- carrossel  -->
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    ...
                                    <div class="product-hover">
                                        ...
                                        <a href="/products/<?php echo htmlspecialchars( $value1["desurl"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="view-details-link"><i class="fa fa-link"></i> OLHAR</a>
                                    </div>
                                </div>
