            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="footer-about-us">
                        <h2>Hcode LOJA</h2>
                        <p>ESTOU SUBSTITUINDO O TEXTO PARA ME LOCALIZAR DENTRO DOS ARQUIVOS HTML</p>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-newsletter">
                        ...
                        <p>PARA RECEBER NOVIDADES FIQUE ATENTO AS NOTICIAS</p>
                        <div class="newsletter-form">
                            <form action="#">
                                <input type="email" placeholder="DIGITE your email">
